    ...
    <div className='bg-white grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-7 w-full h-fit max-w-4xl gap-4 overflow-hidden mx-auto'>
        ...
        <div className='flex flex-row items-center justify-between'>
          ...
          <div className='flex flex-col content-between gap-4'>
            <h1 className='text-2xl font-bold'>
              {user?.member?.name ||
                user?.username + ' ' + user?.member?.last_name ||
                ''}
            </h1>
            <h4>
      ...
      <div className='bg-purpleThirty p-2 sm:p-4 md:p-6 lg:p-8 sm:col-span-2 md:col-span-3 lg:col-span-5 rounded-md '>
        <div className='flex flex-col gap-24'>
          <div>
            ...
            <p>{user?.skills?.description || 'Aun sin informacion.'}</p>
          </div>
          <div>
            <h4>Valoraciones:</h4>
      ...
      <div className='bg-purpleThirty p-2 sm:p-4 md:p-6 lg:p-8 sm:col-span-1 md:col-span-2 lg:col-span-2 rounded-md'>
        <div className='flex flex-col gap-8'>
          ...
          <button className='bg-yellowPrimary text-purpleSecondary py-2 px-4 rounded-full'>
            Hacer intercambio
          </button>
        </div>
      </div>
